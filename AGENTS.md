...
- Deliver multiple requested motions for one asset as named clips in one final GLB unless the user requests separate files. Merge compatible outputs from any provider and verify the final inventory; preserve intermediate revisions.
